...
import style from './DeleteBoardModal.module.scss';
                    ...
                    {!isDeleting ?
                        <>
                            <div className={style.modalHeader}>
                                ...
                                <a>Are you sure you want to delete the board</a>
                                <text>{boardTitle}</text>
                                <span>You will lose access to board resources.</span>
                            </div>
