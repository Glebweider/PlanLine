...
import style from './CreateNewTask.module.scss';
...
const CreateNewTask: React.FC<CreateNewTaskProps> = ({
    isOpen,
    onClose,
    projectId,
    boardId,
    ...
    const create = async () => {
        if (name.length > 24) {
            showAlert(`Task must be no more than ${24} characters`);
            return;
        }
                            ...
                            <div className={style.editorToolbarContainer}>
                                <div className={style.editorToolbar}>
                                    ...
                                    <svg
                                        ...
                                        viewBox="0 0 24 24"
                                        fill="none">
                                        <path d="M8.9373 10C10.0342 10 10.9234 9.10457 10.9234 8C10.9234 6.89543 10.0342 6 8.9373 6C7.84042 6 6.95123 6.89543 6.95123 8C6.95123 9.10457 7.84042 10 8.9373 10Z" stroke="#ACACAC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12.9094 2H8.9373C3.97215 2 1.98608 4 1.98608 9V15C1.98608 20 3.97215 22 8.9373 22H14.8955C19.8606 22 21.8467 20 21.8467 15V10" stroke="#ACACAC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M15.6403 5H21.1019" stroke="#ACACAC" stroke-width="1.5" stroke-linecap="round" />
                                        <path d="M18.3711 7.75V2.25" stroke="#ACACAC" stroke-width="1.5" stroke-linecap="round" />
                                        <path d="M2.65137 18.9496L7.54701 15.6396C8.33151 15.1096 9.46356 15.1696 10.1686 15.7796L10.4963 16.0696C11.2709 16.7396 12.5221 16.7396 13.2967 16.0696L17.4277 12.4996C18.2022 11.8296 19.4535 11.8296 20.228 12.4996L21.8467 13.8996" stroke="#ACACAC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>

                                <div className={style.editorActions}>
                                    <button onClick={onClose} className={style.cancelBtn}>Cancel</button>
                                    <button onClick={create} className={style.saveBtn}>Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
