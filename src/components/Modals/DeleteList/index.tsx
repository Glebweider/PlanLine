...
import style from './DeleteListModal.module.scss';
                    ...
                    {!isDeleting ?
                        <>
                            <div className={style.modalHeader}>
                                ...
                                <a>Are you sure you want to delete the list</a>
                                <text>{listTitle}</text>
                                <span>You will lose access to list resources.</span>
                            </div>
