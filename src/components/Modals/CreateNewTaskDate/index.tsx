...
const CreateNewTaskDate: React.FC<CreateNewTaskDateProps> = ({
    ...
    const updateFullDateTime = (timeValue: string, selectedDay: Date = selected) => {
        if (!timeValue) return;
                        ...
                        <div className={style.timeBlock}>
                            ...
                            <div className={style.timeInput}>
                                ...
                                <div className={style.ampm}>
                                    <button
                                        onClick={() => { setAmpm("AM"); updateFullDateTime(time); }}
                                        className={ampm === "AM" ? style.active : ""}>
                                        AM
                                    </button>
                                    <button
                                        onClick={() => { setAmpm("PM"); updateFullDateTime(time); }}
